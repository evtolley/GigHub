...
namespace GigHub.Models
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        {
            modelBuilder.Entity<Attendance>().HasRequired(a => a.Gig).WithMany(x => x.Attendances).WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<UserNotification>().HasRequired(n => n.User).WithMany(x => x.UserNotifications).WillCascadeOnDelete(false);
